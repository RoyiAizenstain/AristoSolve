...
const EMPTY = {
  title: '', difficulty: 'easy', topic: 'arrays', type: 'algorithm',
  description: '', constraints: '', isPublic: true,
};
    ...
    <Layout>
      <div className="settings-page">
        <div className="settings-heading">
          ...
          <p className="page-sub">Create a new problem for the platform.</p>
        </div>
        ...
        <form className="settings-card" onSubmit={handleSubmit} noValidate>
          ...
          <div className="settings-actions">
            ...
            <button type="submit" className="btn btn-primary" disabled={saving}>
              {saving ? <><span className="spinner" /> Saving…</> : 'Create Problem'}
            </button>
          </div>
